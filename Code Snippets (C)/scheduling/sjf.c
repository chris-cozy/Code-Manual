/*
    ...
    Non-Preemptive
    Minimun average waiting time of all scheduling algorithms
    greedy algorithm
    May cause starvation if shorter processes keep arriving.
    This can be solved by using an ageing concept
